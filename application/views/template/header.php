  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>SIPRS</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>APP - </b>SIPRS</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            $akses = $this->db->get_where('tbl_hak_akses', ['level' => $this->session->level])->result_array();
            foreach ($menu as $data) {
              ?>
              <?php 
              foreach ($akses as $ak) {
                if($ak['id_menu'] == $data['id'] ){

                  ?>

                  <li><a href="<?= base_url('app/') ?><?= $data['url'] ?>"><i class="<?= $data['icon'] ?>"></i> <span><?= $data['title'] ?></span></a></li>
                <?php } } ?>
              <?php } ?>
