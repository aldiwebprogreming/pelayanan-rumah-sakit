    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
        <div class="box-header">
          <h3 class="box-title">   Data Doktor</h3>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-plus"></i> Form Tambah Data Doktor</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form method="post" action="<?= base_url('app/add_doktor') ?>">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nomor Induk Doktor</label>
                      <input type="text" name="no_induk_doktor" class="form-control" required="">
                    </div>
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <tbody>
                <?php $no = 1 ?>
                <?php foreach($doktor as $data){ ?>
                  <tr>
                    <td><?= $no++ ?></td>
                    <td>
                      <?= $data['nama'] ?>
                    </td>
                    <td><?= $data['no_induk_doktor'] ?></td>
                    <td><?= $data['jk'] ?></td>
                  ...
                  <div class="modal fade" id="exampleModaledit<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Edit Data Doktor</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                         <form method="post" action="<?= base_url('app/edit_doktor') ?>">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Nomor Induk Doktor</label>
                            <input type="text" name="no_induk_doktor" class="form-control" value="<?= $data['no_induk_doktor'] ?>" required="">
                          </div>
                ...
                <div class="modal fade" id="exampleModalhapus<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hapus Data Doktor</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        ...
                        <form method="post" action="<?= base_url('app/hapus_doktor') ?>">
                          <input type="hidden" name="id" value="<?= $data['id'] ?>">
