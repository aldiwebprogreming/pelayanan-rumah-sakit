            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"> <i class="fa fa-plus"></i> Form Tambah Data Pasien</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form method="post" action="<?= base_url('app/add_pasien') ?>">


                    <div class="form-group">
                      <label for="exampleInputEmail1">No Rekam Medis</label>
                      <input type="text" name="no_rekammedis" class="form-control" value="<?= $kode ?>" required >
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Pasien</label>
                      <input type="text" name="nama_pasien" class="form-control" required value="">
                    </div>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">No BPSJ</label>
                      <input type="number" name="no_bpjs" class="form-control" required="">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="status_pasien">
                        <option>-- Pilih Satatus Pasien --</option>
                        <option>BPJS</option>
                        <option>Umum</option>
                      </select>
                    </div>
                  ...
                  <div class="modal fade" id="exampleModaledit<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                         <form method="post" action="<?= base_url('app/edit_pasien') ?>">
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">No KTP</label>
                            <input type="number" name="no_ktp" class="form-control" required="" value="<?= $data['no_ktp'] ?>">
                          </div>

                          <div class="form-group">
                            <label for="exampleInputEmail1">No BPSJ</label>
                            <input type="number" name="no_bpjs" class="form-control" value="<?= $data['no_bpjs'] ?>" required="">
                          </div>

                          <div class="form-group">
                            <label for="exampleInputEmail1">No Telp</label>
                            <input type="number" name="notelp" class="form-control" value="<?= $data['notelp'] ?>" required="">
                          </div>
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail1">Tgl Lahir</label>
                            <input type="date" name="tgl_lahir" value="<?= $data['tanggal_lahir'] ?>" class="form-control" required="">
                          </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form method="post" action="<?= base_url('app/hapus_pasien') ?>">
                          <input type="hidden" name="id" value="<?= $data['id'] ?>">
